 ...
 */
namespace block_ollama_chat\privacy;
...
class provider implements 
    ...
    public static function get_metadata(collection $collection): collection {
        $collection->add_database_table(
            'block_ollama_chat_log',
             [
                'userid' => 'privacy:metadata:ollama_chat_log:userid',
                'usermessage' => 'privacy:metadata:ollama_chat_log:usermessage',
                'airesponse' => 'privacy:metadata:ollama_chat_log:airesponse',
                'timecreated' => 'privacy:metadata:ollama_chat_log:timecreated'
             ],
            'privacy:metadata:ollama_chat_log'
        );
    ...
    public static function get_users_in_context(userlist $userlist) {
        ...
        if ($DB->record_exists('block_ollama_chat_log', ['userid' => $context->instanceid])) {
    ...
    public static function export_user_data(approved_contextlist $contextlist) {
        ...
        // Sent messages.
        $sql = "SELECT id, userid, usermessage, airesponse, timecreated FROM {block_ollama_chat_log} WHERE userid = :userid";
        ...
        if (!empty($records)) {
            ...
            writer::with_context($context)->export_data(
                [get_string('privacy:chatmessagespath', 'block_ollama_chat')],
                $messages
            );
        }
    }
    ...
    public static function delete_data_for_all_users_in_context(\context $context) {
        ...
        if ($context->contextlevel == CONTEXT_USER) {
            $DB->delete_records('block_ollama_chat_log', ['userid' => $context->instanceid]);
        }
    }
