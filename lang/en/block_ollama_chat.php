...
$string['ollama_chat_logs'] = 'Ollama Chat Logs';
$string['ollama_chat:addinstance'] = 'Add a new Ollama Chat block';
$string['ollama_chat:myaddinstance'] = 'Add a new Ollama Chat block to the My Moodle page';
$string['ollama_chat:viewreport'] = 'View Ollama Chat log report';
$string['privacy:metadata:ollama_chat_log'] = 'Logged user messages sent to Ollama. This includes the user ID of the user that sent the message, the content of the message, the response from Ollama, and the time that the message was sent.';
$string['privacy:metadata:ollama_chat_log:userid'] = 'The ID of the user that sent the message.';
$string['privacy:metadata:ollama_chat_log:usermessage'] = 'The content of the message.';
$string['privacy:metadata:ollama_chat_log:airesponse'] = 'The response from Ollama.';
$string['privacy:metadata:ollama_chat_log:timecreated'] = 'The time the message was sent.';
...
$string['apikeydesc'] = 'The API Key for your Ollama account or Azure API key';
$string['apiendpoint'] = 'API endpoint';
$string['apiendpointdesc'] = 'The API endpoint of your Ollama installation';
...
$string['assistantdesc'] = 'The default assistant attached to your Ollama account that you would like to use for the response';
$string['noassistants'] = 'You haven\'t created any assistants yet. You need to create one <a target="_blank" href="https://platform.openai.com/assistants">in your Ollama account</a> before you can select it here.';
...
$string['resourcenamedesc'] = 'The name of your Azure Ollama Resource.';
...
$string['advanceddesc'] = 'Advanced arguments sent to Ollama. Don\'t touch unless you know what you\'re doing!';
...
$string['config_assistant_help'] = "Choose the assistant you would like to use for this block. More assistants can be created in the Ollama account that this block is configured to use.";
...
$string['apikeymissing'] = 'Please add your Ollama API key to the block settings.';
...
$string['openaitimedout'] = 'ERROR: Ollama did not provide a response in time.';